...
export class NotebookContainerizerPanel extends React.Component<IProps> {
            ...
            <ThemeProvider theme={theme}>
                <div className={'lifewatch-widget'}>
                    <div className={'lifewatch-widget-content'}>
                        <div>
                            <p className={'lw-notebook-containerizer2-header'}>
                                Component containerizer
                            </p>
                            <Divider />
                            <div>
                                <p className={'lw-notebook-containerizer2-curr-nb'}>
