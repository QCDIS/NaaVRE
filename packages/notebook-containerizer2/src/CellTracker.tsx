    ...
    render() {
        return (
            <ThemeProvider theme={theme}>
                <div>
                    <div className={'lw-notebook-containerizer2-editor'}>
                    ...
                    {this.state.currentCell!= null ? (
                        <div>
                            {this.state.currentCell.inputs.length > 0 ? (
                                <div>
                                    <p className={'lw-notebook-containerizer2-preview'}>Inputs</p>
                                    <TableContainer component={Paper} className={'lw-notebook-containerizer2-table'}>
                            ...
                            {this.state.currentCell.outputs.length > 0 ? (
                                <div>
                                    <p className={'lw-notebook-containerizer2-preview'}>Outputs</p>
                                    <TableContainer component={Paper} className={'lw-notebook-containerizer2-table'}>
                                        <Table aria-label="simple table">
                                            <TableBody>
                            ...
                            {this.state.currentCell.params.length > 0 ? (
                                <div>
                                    <p className={'lw-notebook-containerizer2-preview'}>Parameters</p>
                                    <TableContainer component={Paper} className={'lw-notebook-containerizer2-table'}>
                                        <Table aria-label="simple table">
                                            <TableBody>
                            ...
                            {this.state.currentCell.dependencies.length > 0 ? (
                                <div>
                                    <p className={'lw-notebook-containerizer2-preview'}>Dependencies</p>
                                    <TableContainer component={Paper} className={'lw-notebook-containerizer2-table'}>
                                        <Table aria-label="simple table">
                                            <TableBody>
                            ...
                            <div>
                                <p className={'lw-notebook-containerizer2-preview'}>Base Image</p>
                                <Autocomplete
                                    disablePortal
                    ...
                    <div>
                        <Button variant="contained"
                            className={'lw-notebook-containerizer2-button'}
