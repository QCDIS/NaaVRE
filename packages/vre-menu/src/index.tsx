...
const extension: JupyterFrontEndPlugin<void> = {
  ...
  activate: (
      ...
      palette.addItem({command: commandSettings, category, args: { origin: 'from the palette' }});
      palette.addItem({command: 'create-vre-composer', category, args: { origin: 'from the palette' }});
      ...
      vreMenu.addItem({ command: 'create-vre-composer', args: { origin: 'from the menu' } });
