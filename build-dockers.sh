...
sudo docker build . --file Dockerfile-laserfarm-pytorch -t qcdis/n-a-a-vre-laserfarm:$1
...
sudo docker build . --file Dockerfile-laserfarm-pytorch -t qcdis/n-a-a-vre-pytorch:$1
